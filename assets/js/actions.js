				...
				$.each(json, function(i, item) {
					...
					$.ajax({
						...
						success:function(json){
							...
							$('#'+post_id+'').append('<div class="flex justify-content-center mg-b50" id="div-to-coment"><div class="img-circle-coment"><img src="'+img_url+'" class="img-coment" id="img-profile-coment"/></div><form method="GET" id="form-coment"><textarea id="'+id_post+'" class="coment text-black" type="text" name="nick" placeholder="Comentário..."></textarea></form><button class="submit mg-t10" onclick="comentar('+post_id+','+toQuerySelector+')" ></button></div>');
						}, 
						error:function() {
